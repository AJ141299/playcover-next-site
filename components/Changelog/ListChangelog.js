...
const ListChangelog = ({ gitData }) => {
  ...
  return (
    <div>
      { gitData.map((data) => {
        return (
          <div div className="lg:animate-speedAboveEntranceNormal first:text-pink-500 text-gray-700 dark:text-gray-400 mb-10 " key={ data.id } >
            ...
            <div className="lg:animate-speedAboveEntranceSlow">
              <ChangelogParser data={ data } />
            </div>

            {/* buttons */ }
            <div className="lg:animate-speedAboveEntranceSlowest">
