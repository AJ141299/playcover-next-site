	...
	return (
		<>
			...
			<div className="flex justify-center pb-6">
				<div className="shadow-md w-[85%] md:w-[55%] rounded-lg  bg-gray-200 dark:bg-[#222222] transition duration-200 ease-in-out lg:animate-slideUp">
					<div className="p-4 md:p-10 space-y-5 flex flex-col ease-out lg:animate-fadeSlideUp">
